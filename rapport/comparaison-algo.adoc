...
Il vérifie ainsi la taille de la chaîne de caractère ainsi que des caractères présents au sein de la chaîne de caractère renseignée dans différentes conditions, pour bien comprendre comment l'analyse se fait, étape par étape. +
