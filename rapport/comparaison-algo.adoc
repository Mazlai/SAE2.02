...
[.text-justify]
Pour faire que les tests que vous avez posé puissent être réalisés, veuillez ajouter le code suivant tout en haut du fichier ``test.py`` (situé au chemin renseigné ci-dessous) : +
...
|Test passé ✓
|``'Coucou\__JM__B'`` 
|Environ 0.0000008s soit 0.0008s
|3600
...
|Test passé ✓ 
|``'Coucou\__JM__B'`` (dupliquée 100x) 
|Environ une nanoseconde, soit 0.000006ms
|13000

|``'Cou_cou\__J_M__B'`` (dupliquée 10000x) 
|Test passé ✓ 
|``Coucou\__JM__B`` (dupliquée 10000x) 
|Environ 25 nanosecondes, soit 0.0000108ms
|130000

|``'Cou_cou\__J_M__B'`` (dupliquée 100000x) 
|Test passé ✓ 
|``'Coucou\__JM__B'`` (dupliquée 100000x) 
|Environ 131 nanosecondes, soit 0.000639ms
|1300000
|===
