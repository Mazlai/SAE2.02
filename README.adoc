...
*Lien vers le rapport :* https://github.com/IUT-Blagnac/sae2-02-Mazlai/blob/main/rapport/comparaison-algo.adoc[__Cliquer ici__]
...
| 2    | link:src/main/java/eraser/Eraser2.java[ici] | Java     | Simplicité
| 3    | link:solution1.c[ici]                       | C        | Efficacité
| 4    | link:solution2.c[ici]                       | C        | Sobriété numérique
| 5    | link:solution.py[ici]                       | Python   | Efficacité
|==========================================================================
